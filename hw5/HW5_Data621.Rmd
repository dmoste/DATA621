...
```{r}
rawwine <- read.csv("https://raw.githubusercontent.com/dmoste/DATA621/master/hw5/wine-training-data.csv", header=T, sep = ",")
rawwine_evaluation <- read.csv("https://raw.githubusercontent.com/dmoste/DATA621/master/hw5/wine-evaluation-data.csv", header=T, sep = ",")
```
